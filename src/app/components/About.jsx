...
const AboutSection = () => {
  ...
  <div className="max-w-7xl w-full px-5 sm:px-6 lg:px-8">
    ...
    <div className="flex flex-col md:flex-row items-center mt-5 md:mt-0 md:-mx-4">
      <div className="w-full md:w-1/2 md:px-4 flex justify-center"> 
        <Image className="lg:w-5/6 xl:w-11/12 rounded-lg shadow-lg" src="./images/sites/9.webp" alt="About" width={350} height={350} />
      </div>
